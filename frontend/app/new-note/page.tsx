...
export default function NewNotePage() {
    ...
    useEffect(() => {
        if (categories && categories.length > 0 && !selectedCategoryId) {
            ...
            // setSelectedCategoryId(firstCategory.id) // Removed
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        createNote.mutate({
            ...
            // audio_file: null // Todo: Voice recording
        })
    }
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col h-full max-w-7xl mx-auto w-full">
                                ...
                                <FormItem>
                                    <FormControl>
                                        <CategorySelect
                                            ...
                                            onChange={(val) => {
                                                field.onChange(val)
                                                // setSelectedCategoryId(val) // Removed
                                            }}
                                            value={field.value}
                                        />
                                    </FormControl>
                    ...
                    >
                        ...
                        <div className="absolute bottom-8 right-8 flex gap-4">
                            {/* Only show Voice button for now as per design, but keeping submit nearby or hidden? 
                                Design calls for voice button. We also need a way to save. 
                                I'll keep the submit button but style it minimally or floating.
                             */}
